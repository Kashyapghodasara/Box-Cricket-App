                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-md text-gray-300">
                            ...
                            <li><button onClick={() => scrollToSection('Slote')} className="hover:text-white transition">Book Now</button></li>
                            <li><button onClick={() => scrollToSection('Slote')} className="hover:text-white transition">About</button></li>
