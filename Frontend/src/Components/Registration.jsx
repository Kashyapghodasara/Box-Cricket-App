    ...
    const adminLoginHandler = async (e) => {
        ...
        try {
            ...
            if (res.data.success === true) {
                ...
                // 2. Redirect to the Admin App, passing the token in the URL
                const adminUrl = `https://admin-box-cricket-app.vercel.app/?token=${accessToken}`;

                // Use window.location.replace so the user can't click "back" to the token URL
